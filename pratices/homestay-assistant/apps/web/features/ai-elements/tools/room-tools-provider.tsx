  ...
  useFrontendTool(
    {
      ...
      description:
        "Update the room grid on the home page. Pass rooms from getRooms or find_room as-is. After this succeeds, always send one short guest-facing chat reply summarizing that rooms are ready.",
